...
CREATE UNIQUE INDEX IF NOT EXISTS "candidate_bets_unique_candidate_idx" ON "candidate_bets" USING btree ("snapshot_date","game_key","market_type","side");--> statement-breakpoint
